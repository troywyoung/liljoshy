# Add Idea: Did the page get much longer?
...
At some point recently, Josh Chisholm starting adding to the page. Did he add lots of sections or just update the content in the existing sections? Review the git history
